const ENTITY_LINKS: ReadonlyArray<readonly [RegExp, string]> = [
  ...
  [/\bUltimate Sakapatate\b/, "/ultimate-sakapatate"],
  [/\bMatthieu the Colossus\b/, "/matthieu-the-colossus"],
  [/\bThe Paintress\b/, "/the-paintress"],
  [/\bMask Keeper\b/, "/mask-keeper"],
  [/\bDualliste\b/, "/dualliste"],
  [/\bLampmaster\b/, "/lampmaster"],
  [/\bGlissando\b/, "/glissando"],
  [/\bFran[cç]ois\b/, "/francois"],
  [/\bGoblu\b/, "/goblu"],
  [/\bSir[eè]ne\b/, "/sirene"],
  [/\bRenoir\b/, "/renoir"],
  [/\bCreation\b/, "/creation"],
  [/\bStalact\b/, "/stalact"],
  [/\bVisages\b/, "/visages"],
  [/\bEveque\b/, "/eveque"],
